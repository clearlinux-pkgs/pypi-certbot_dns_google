...
Version  : 3.3.0
Release  : 45
URL      : https://files.pythonhosted.org/packages/2f/7d/1f6ea0ddc6e61189751d348ce959aa1d060e16f40b6ddb074dd99c4c6007/certbot_dns_google-3.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/2f/7d/1f6ea0ddc6e61189751d348ce959aa1d060e16f40b6ddb074dd99c4c6007/certbot_dns_google-3.3.0.tar.gz
...
%prep
%setup -q -n certbot_dns_google-3.3.0
cd %{_builddir}/certbot_dns_google-3.3.0
pushd ..
cp -a certbot_dns_google-3.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741735366
