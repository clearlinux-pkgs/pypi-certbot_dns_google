...
Version  : 2.6.0
Release  : 25
URL      : https://files.pythonhosted.org/packages/47/09/4bf731fd99518fd500aa40be675119f1753bcd36b39d03071edbfd0f8d3e/certbot-dns-google-2.6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/47/09/4bf731fd99518fd500aa40be675119f1753bcd36b39d03071edbfd0f8d3e/certbot-dns-google-2.6.0.tar.gz
...
%prep
%setup -q -n certbot-dns-google-2.6.0
cd %{_builddir}/certbot-dns-google-2.6.0
pushd ..
cp -a certbot-dns-google-2.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684607507
