...
Source0  : https://files.pythonhosted.org/packages/12/c0/6ec118ea6a1ae49b2af4e0afd75b2f5c4849b39bfa7771deaf9b2d8d2831/certbot_dns_google-3.1.0.tar.gz
...
%prep
%setup -q -n certbot_dns_google-3.1.0
cd %{_builddir}/certbot_dns_google-3.1.0
pushd ..
cp -a certbot_dns_google-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736299131
