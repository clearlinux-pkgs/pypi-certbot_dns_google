...
Version  : 2.7.2
Release  : 29
URL      : https://files.pythonhosted.org/packages/58/ac/f879ffd410048167988f89176f2d29f52ef0070f88cd237ef79abc03d1d4/certbot-dns-google-2.7.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/58/ac/f879ffd410048167988f89176f2d29f52ef0070f88cd237ef79abc03d1d4/certbot-dns-google-2.7.2.tar.gz
...
%prep
%setup -q -n certbot-dns-google-2.7.2
cd %{_builddir}/certbot-dns-google-2.7.2
pushd ..
cp -a certbot-dns-google-2.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697824629
