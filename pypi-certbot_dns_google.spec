...
Version  : 3.2.0
Release  : 43
URL      : https://files.pythonhosted.org/packages/18/cf/2dbd0896baf3ffa0f4653c441c19f6b322cce4716945cbfc4e4cd8b01754/certbot_dns_google-3.2.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/18/cf/2dbd0896baf3ffa0f4653c441c19f6b322cce4716945cbfc4e4cd8b01754/certbot_dns_google-3.2.0.tar.gz
...
%prep
%setup -q -n certbot_dns_google-3.2.0
cd %{_builddir}/certbot_dns_google-3.2.0
pushd ..
cp -a certbot_dns_google-3.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739373502
